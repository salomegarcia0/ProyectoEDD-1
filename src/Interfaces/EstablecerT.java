...
/**
 * Esta clase representa la ventana para establecer un nuevo valor para 't'.
 * Hereda de JFrame y contiene componentes gráficos para la interacción del usuario.
 * 
 * @author salom
 */
public class EstablecerT extends javax.swing.JFrame {
    ...
    /**
     * Crea una nueva instancia de la clase EstablecerT.
     * Inicializa los componentes gráficos y establece el valor actual de 't' en la etiqueta correspondiente.
     */
    public EstablecerT() {
        initComponents();
    ...
    private void initComponents() {
        ...
        getContentPane().add(Menu, new org.netbeans.lib.awtextra.AbsoluteConstraints(130, 410, 330, 40));
    ...
    /**
     * Método que se ejecuta al hacer clic en la etiqueta del menú.
    ...
    /**
     * Método que se ejecuta al hacer clic en la etiqueta para establecer 't'.
     * Valida la entrada y actualiza el valor de 't' si es válido.
     * 
     * @param evt el evento de clic del ratón
     */
     ...
     * Crea y muestra la ventana de EstablecerT.
     * 
