...
/**
 * Clase que representa la interfaz gráfica para colocar sucursales en el sistema.
 * Permite agregar o eliminar sucursales de estaciones en un grafo de estaciones.
...
public class ColocarSucursal extends javax.swing.JFrame {
    ...
    // Modelos de los JComboBox
    DefaultComboBoxModel modelo1 = new DefaultComboBoxModel();
    DefaultComboBoxModel modelo2 = new DefaultComboBoxModel();
    
    /**
     * Constructor de la clase ColocarSucursal.
     * Inicializa la interfaz gráfica y actualiza los JComboBox con las estaciones.
     */
    public ColocarSucursal() {
        initComponents();
        this.ActualizarCombo();// Actualiza los JComboBox al inicio
    }
    /**
     * Actualiza los JComboBox con las estaciones que tienen y no tienen sucursal.
     */
    public void ActualizarCombo() {
        modelo1.removeAllElements(); // Limpiar modelo1
        modelo2.removeAllElements(); // Limpiar modelo2
        
        // Obtener estaciones sin sucursal y agregarlas al primer JComboBox
        ...
        // Obtener estaciones con sucursal y agregarlas al segundo JComboBox
    ...
    /**
     * Maneja el evento de clic en el botón del menú.
     * Cierra la ventana actual y abre la ventana del menú.
     * 
    ...
    /**
     * Maneja el evento de clic en el botón para agregar sucursal.
     * Verifica si se seleccionó una estación y la agrega como sucursal.
    ...
    /**
     * Maneja el evento de clic en el botón para eliminar sucursal.
     * Verifica si se seleccionó una estación y la elimina como sucursal.
     * Muestra un mensaje de éxito o error según corresponda.
     * 
     * @param evt el evento de clic del mouse
     */
